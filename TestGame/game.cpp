...
public:
    ...
    block(char *shape, int gameWidth)
    {
        ...
        for (int i = 0;; i++)
        {
            ...
            {
                if (lastWasNull)
                    break; // two NULL's in a row, we're done.
                else
                {
...
{
public:
    blockT(int gameWidth) : block((char *)" t \0"
                                          "ttt\0",
                                  gameWidth)
    {
    }
...
{
public:
    block_(int gameWidth) : block((char *)"====\0", gameWidth)
    {
    }
};
...
{
public:
    blockL(int gameWidth) : block((char *)"l  \0"
                                          "lll\0",
                                  gameWidth)
    {
    }
...
{
public:
    block7(int gameWidth) : block((char *)"  7\0"
                                          "777\0",
                                  gameWidth)
    {
    }
...
{
public:
    block2(int gameWidth) : block((char *)" 22\0"
                                          "22 \0",
                                  gameWidth)
    {
    }
...
{
public:
    blockZ(int gameWidth) : block((char *)"zz \0"
                                          " zz\0",
                                  gameWidth)
    {
    }
...
{
public:
    block0(int gameWidth) : block((char *)"00\0"
                                          "00\0",
                                  gameWidth)
    {
    }
...
block *newBlock(int which, int gameWidth)
{
    ...
    {
    case 0:
        return new block0(gameWidth);
    case 1:
        return new blockZ(gameWidth);
    case 2:
        return new block2(gameWidth);
    case 3:
        return new block7(gameWidth);
    case 4:
        return new blockL(gameWidth);
    case 5:
        return new block_(gameWidth);
    case 6:
        return new blockT(gameWidth);
    default:
        return new blockT(gameWidth);
    }
}
